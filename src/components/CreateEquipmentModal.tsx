  ...
  return (
    ...
    >
      <div
        ...
        className="glass-panel-elevated rounded-2xl max-w-xl w-full shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col border border-white/15 text-slate-100"
      >
        ...
        <div className="p-4 border-b border-white/10 bg-slate-950/80 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-white">Registrar Nuevo Equipo de Hardware</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto flex-1 space-y-4 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              >
                <option value="camera" className="bg-slate-900 text-white">Cámara Principal / B-Cam</option>
                <option value="lens" className="bg-slate-900 text-white">Óptica / Lente Cinema</option>
                <option value="lighting" className="bg-slate-900 text-white">Iluminación / Gaffer</option>
                <option value="audio" className="bg-slate-900 text-white">Microfonía & Sonido Directo</option>
                <option value="mobile_capture" className="bg-slate-900 text-white">Captura Móvil / Gimbal</option>
                <option value="editing_station" className="bg-slate-900 text-white">Estación DIT / Edición</option>
              </select>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step={5}
                  required
                  className="input-impeccable pl-8 font-mono text-emerald-400 font-bold"
                />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="input-impeccable font-mono flex-1"
              />
            </div>
          </div>

          {/* Submit Buttons */}
          <div className="pt-3.5 border-t border-white/10 flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={() => setIsCreateEquipmentModalOpen(false)}
